<?php
    ...
    $product_id=limpiar_cadenas($_POST['img_up_id']);
    ...
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
            No ha seleccionado ninguna imagen o foto valida
        </div>
    ';
    exit();
    }
    ...
    if ($actualizar_producto->execute($marcadores)) {
        ...
        echo '
            <div class="notification is-warning is-light">
                ...
                No podemos subir la imagen o foto en este momento, por favor intente nuevamente
