<?php
    ...
    $id=limpiar_cadenas($_POST['usuario_id']);
    ...
    $admin_usuario=limpiar_cadenas($_POST['administrador_usuario']);
    $admin_clave=limpiar_cadenas($_POST['administrador_clave']);
...
if ($actualizar_usuario->execute($marcadores)) {
    ...
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
            No se pudo actualizar el USUARIO, por favor intentelo nuevamente
        </div>
    ';
}
