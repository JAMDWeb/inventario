<?php
    ...
    $id=limpiar_cadenas($_POST['producto_id']);
    ...
    if ($categoria!=$datos['producto_categoria']) {
    ...
    if ($actualizar_producto->execute($marcadores)) {
        echo '
            <div class="notification is-info is-light">
                ...
                La producto se actualizo con exito.
            </div>
        ';
    } else {
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se pudo actualizar el producto, por favor intentelo nuevamente
            </div>
        ';
    }
