<?php
    ...
    $product_id=limpiar_cadenas($_POST['img_del_id']);
    ...
    if (is_file($img_dir.$datos['producto_foto'])) {
        ...
        if (!unlink($img_dir.$datos['producto_foto'])) {
            echo '
                <div class="notification is-danger is-light">
                    <strong>¡Ocurrio un error inesperado!</strong><br>
                    Error al intentar eliminar La imagen del producto, por favor 
    ...
    if ($actualizar_producto->execute($marcadores)) {
        ...
        echo '
            <div class="notification is-warning is-light">
                <strong>¡IMAGEN o FOTO eliminada!</strong><br>
                Ocurrieron algunos inconvenientes, sin embargo la imagen del 
                producto ha sido eliminada, pulse Aceptar para recargar los cambios.
